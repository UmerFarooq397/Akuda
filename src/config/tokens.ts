...
import { ARBITRUM, ARBITRUM_GOERLI, AVALANCHE, AVALANCHE_FUJI, BCS_TESTNET } from "./chains";
...
export const TOKENS: { [chainId: number]: Token[] } = {
  ...
  [BCS_TESTNET]: [
    ...
    },
    {
      ...
      symbol: "USDC",
      decimals: 6,
      address: "0x89c8da7569085d406800c473619d0c6b7ac0ce8e",
      isStable: true,
      isV1Available: true,
      imageUrl: "https://assets.coingecko.com/coins/images/6319/thumb/USD_Coin_icon.png?1547042389",
      coingeckoUrl: "https://www.coingecko.com/en/coins/usd-coin",
    ...
    },
    {
      ...
      decimals: 6,
      priceDecimals: 4,
      address: "0xad2cf40e39716eb6bbb976bc9d1b09b5ad3bf2d6",
      isSynthetic: true,
      isV1Available: true,
      imageUrl: "https://assets.coingecko.com/coins/images/44/small/xrp-symbol-white-128.png?1605778731",
      coingeckoUrl: "https://www.coingecko.com/en/coins/xrp",
...
const CHAIN_IDS = [ARBITRUM, ARBITRUM_GOERLI, AVALANCHE, AVALANCHE_FUJI, BCS_TESTNET];
...
export function getTokenBySymbol(chainId: number, symbol: string) {
  console.log("Token array::  ", TOKENS_BY_SYMBOL_MAP[chainId]);
