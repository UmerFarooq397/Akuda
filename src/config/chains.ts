...
export const SUPPORTED_CHAIN_IDS = [ARBITRUM, AVALANCHE, BCS_TESTNET];

if (isDevelopment()) {
  SUPPORTED_CHAIN_IDS.push(AVALANCHE_FUJI, ARBITRUM_GOERLI, BCS_TESTNET);
}
...
export const FALLBACK_PROVIDERS = {
  ...
  [BCS_TESTNET]: ["https://arb-goerli.g.alchemy.com/v2/cZfd99JyN42V9Clbs_gOvA3GSBZH1-1j"]
};
