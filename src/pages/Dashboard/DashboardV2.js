...
import { ARBITRUM, AVALANCHE, BCS_MAINNET, getChainName } from "config/chains";
...
const ACTIVE_CHAIN_IDS = [ARBITRUM, AVALANCHE, BCS_MAINNET];
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <TooltipComponent
                      ...
                      position="right-bottom"
                      renderContent={() => (
                        <span>{t`Assets Under Management: Akuda staked (All chains) + GLP pool (${chainName}).`}</span>
                      )}
                    />
                  </div>
                </div>
                  ...
                  <div className="App-card-title">
                    <div className="App-card-title-mark">
                      ...
                      <div className="App-card-title-mark-info">
                        <div className="App-card-title-mark-title">Akuda</div>
                        <div className="App-card-title-mark-subtitle">Akuda</div>
                      </div>
                      <div>
