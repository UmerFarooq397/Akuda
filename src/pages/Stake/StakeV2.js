      ...
      <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title}>
        <Trans>
          <div>
            ...
            <br />
            <br />
            esAkuda tokens that have been converted to Akuda will remain as Akuda tokens.
            <br />
            <br />
            To claim Akuda tokens without withdrawing, use the "Claim" button under the Total Rewards section.
            <br />
            <br />
          </div>
        </Trans>
...
export default function StakeV2({ setPendingTxns, connectWallet }) {
  ...
  const showGmxVesterDepositModal = () => {
    ...
    setVesterDepositTitle(t`Akuda Vault`);
    setVesterDepositStakeTokenLabel("staked Akuda + esAkuda + Multiplier Points");
  ...
  const showGmxVesterWithdrawModal = () => {
    ...
    setVesterWithdrawTitle(t`Withdraw from Akuda Vault`);
  ...
  const showUnstakeGmxModal = () => {
    ...
    setUnstakeModalTitle(t`Unstake Akuda`);
    ...
    setUnstakeValue("");
    setUnstakingTokenSymbol("Akuda");
    setUnstakeMethodName("unstakeAkuda");
  };

  const showUnstakeEsGmxModal = () => {
    setIsUnstakeModalVisible(true);
    setUnstakeModalTitle(t`Unstake esAkuda`);
    ...
    setUnstakeModalReservedAmount(vestingData.gmxVesterPairAmount);
    setUnstakeValue("");
    setUnstakingTokenSymbol("esAkuda");
    setUnstakeMethodName("unstakeEsAkuda");
  };
  ...
  if (totalRewardTokensAndGlp && totalRewardTokensAndGlp.gt(0)) {
    ...
    if (processedData.gmxInStakedGmx && processedData.gmxInStakedGmx.gt(0)) {
      gmxAmountStr = formatAmount(processedData.gmxInStakedGmx, 18, 2, true) + " Akuda";
    }
    let esGmxAmountStr;
    if (processedData.esGmxInStakedGmx && processedData.esGmxInStakedGmx.gt(0)) {
      esGmxAmountStr = formatAmount(processedData.esGmxInStakedGmx, 18, 2, true) + " esAkuda";
    }
    let mpAmountStr;
    ...
    <div className="default-container page-layout">
      ...
      <div className="section-title-block">
        ...
        <div className="section-title-content">
          ...
          <div className="Page-description">
            <Trans>
              Stake <ExternalLink href="https://docs.gmx.io/docs/tokenomics/gmx-token">Akuda</ExternalLink> and{" "}
      ...
      <div className="StakeV2-content">
        <div className="StakeV2-cards">
          <div className="App-card StakeV2-gmx-card">
            <div className="App-card-title">Akuda</div>
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxBalance", 18, 2, true)} Akuda ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxInStakedGmx", 18, 2, true)} Akuda ($
              ...
              <div className="App-card-row">
                ...
                {totalGmxSupply && (
                  <div>
                    {formatAmount(totalGmxSupply, 18, 0, true)} Akuda ($
          ...
          <div className="App-card">
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "esGmxBalance", 18, 2, true)} esAkuda ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "esGmxInStakedGmx", 18, 2, true)} esAkuda ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "stakedEsGmxSupply", 18, 0, true)} esAkuda ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatAmount(esGmxSupply, 18, 0, true)} esAkuda (${formatAmount(esGmxSupplyUsd, USD_DECIMALS, 0, true)}
                  )
                </div>
              </div>
              <div className="App-card-divider"></div>
      ...
      <div>
        <div className="Tab-title-section">
          ...
          <div className="Page-description">
            <Trans>
              Convert esAkuda tokens to Akuda tokens.
              <br />
              Please read the{" "}
                        ...
                        return (
                          <div>
                            <Trans>
                              ...
                              converted to Akuda from the{" "}
                              {formatKeyAmount(vestingData, "gmxVesterVestedAmount", 18, 4, true)} esAkuda deposited for
                              vesting.
                            </Trans>
                          </div>
                        );
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      ...
                      renderContent={() => (
                        <Trans>
                          {formatKeyAmount(vestingData, "gmxVesterClaimable", 18, 4, true)} Akuda tokens can be claimed,
                        ...
                        return (
                          <div>
                            <Trans>
                              ...
                              converted to Akuda from the{" "}
                              {formatKeyAmount(vestingData, "glpVesterVestedAmount", 18, 4, true)} esAkuda deposited for
                              vesting.
                            </Trans>
                          </div>
                        );
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      ...
                      renderContent={() => (
                        <Trans>
                          {formatKeyAmount(vestingData, "glpVesterClaimable", 18, 4, true)} Akuda tokens can be claimed,
                          use the options under the Total Rewards section to claim them.
                        </Trans>
                      )}
                    />
