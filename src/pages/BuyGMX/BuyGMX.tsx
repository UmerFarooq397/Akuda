        ...
        <div className="section-title-block">
          <div className="section-title-content">
            <div className="Page-title">
              <Trans>Buy Akuda on {getChainName(chainId)}</Trans>
            </div>
            <div className="Page-description">
              <Trans>Choose to buy from decentralized or centralized exchanges.</Trans>
              <br />
              <Trans>
                To purchase Akuda on the {isArbitrum ? "Avalanche" : "Arbitrum"} blockchain, please{" "}
...
function DecentralisedExchanges({ chainId, externalLinks }) {
  const isArbitrum = chainId === ARBITRUM;
  return (
    <Card title={t`Buy Akuda from decentralized exchanges`}>
      <div className="App-card-content">
        {isArbitrum ? (
          <div className="exchange-info-group">
            <div className="BuyGMXGLP-description">
              <Trans>Buy Akuda from Uniswap (make sure to select Arbitrum):</Trans>
            </div>
          ...
          <div className="exchange-info-group">
            <div className="BuyGMXGLP-description">
              <Trans>Buy Akuda from Traderjoe:</Trans>
            </div>
            <div className="buttons-group col-1">
              <Button
                variant="secondary"
        ...
        <div className="exchange-info-group">
          <div className="BuyGMXGLP-description">
            <Trans>Buy Akuda using Decentralized Exchange Aggregators:</Trans>
          </div>
          <div className="buttons-group">
        ...
        <div className="exchange-info-group">
          <div className="BuyGMXGLP-description">
            <Trans>Buy Akuda using any token from any network:</Trans>
          </div>
          <div className="buttons-group">
        ...
        {isArbitrum && (
          <div className="exchange-info-group">
            <div className="BuyGMXGLP-description">
              <Trans>Akuda bonds can be bought on Bond Protocol with a discount and a small vesting period:</Trans>
            </div>
            <div className="buttons-group col-1">
              <Button
                variant="secondary"
...
function CentralisedExchanges({ chainId }) {
  return (
    <Card title={t`Buy Akuda from centralized services`}>
      <div className="App-card-content">
        <div className="exchange-info-group">
          <div className="BuyGMXGLP-description">
            <Trans>Buy Akuda from centralized exchanges:</Trans>
          </div>
          <div className="buttons-group">
        ...
        <div className="exchange-info-group">
          <div className="BuyGMXGLP-description">
            <Trans>Buy Akuda using FIAT gateways:</Trans>
          </div>
