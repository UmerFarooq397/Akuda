...
export default function Home({ showRedirectModal, redirectPopupTimestamp }) {
  ...
  //   answer: "The GMX token is the governance token of the GMX ecosystem, it provides the token owner voting rights on the direction of the GMX platform.<br><br>Additionally, when GMX is staked you will earn 30% of the platform-generated fees, you will also earn Escrowed Akudo tokens and Multiplier Points."
  // }, {
  //   id: 3,
        ...
        <div className="Home-cta-container default-container">
          <div className="Home-cta-info">
            ...
            <div className="Home-cta-info__description">
              <Trans>Akuda is currently live on Arbitrum and Avalanche.</Trans>
            </div>
          </div>
