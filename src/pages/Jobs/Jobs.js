...
function NoJob() {
  return (
    <Card title={t`No open positions at Akuda currently`}>
      <div className="body-para">
        <p className="subheading">
          <Trans>
            Akuda is not actively looking for new hires at the moment. However, if you think you can contribute to the
