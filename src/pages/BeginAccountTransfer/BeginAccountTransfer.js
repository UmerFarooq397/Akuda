...
export default function BeginAccountTransfer(props) {
  ...
  const getError = () => {
    ...
    if (hasVestedGmx) {
      return t`Vested Akuda not withdrawn`;
    }
    if (hasVestedGlp) {
      return t`Vested Akuda not withdrawn`;
    }
      ...
      <div className="Page-title-section">
        ...
        <div className="Page-description">
          <Trans>
            ...
            <br />
            This will transfer all your Akuda, esGMX, GLP and Multiplier Points to your new account.
            <br />
            Transfers are only supported if the receiving account has not staked Akuda or GLP tokens before.
            <br />
        ...
        <div className="input-form">
          ...
          <div className="BeginAccountTransfer-validations">
            <ValidationRow isValid={!hasVestedGmx}>
              <Trans>Sender has withdrawn all tokens from Akuda Vesting Vault</Trans>
            </ValidationRow>
            ...
            <ValidationRow isValid={!hasStakedGmx}>
              <Trans>Receiver has not staked Akuda tokens before</Trans>
            </ValidationRow>
