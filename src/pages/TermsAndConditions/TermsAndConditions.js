      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">Akuda</div>
          ...
          <div className="content">
            <div className="section">
              <p className="body-text">
                Welcome to Akuda.io ("we," "us," or "our"), the informational resource for Akuda Protocol, as defined below.
              </p>
              <p className="body-text">
                Akuda.io provides information and resources about the fundamentals of the decentralized non-custodial
                protocol called the Akuda Protocol (the "Akuda Protocol," "Protocol," or "Akuda DApp"). Akuda.io is not an
                available access point to the Akuda Protocol.
              </p>
              <p className="body-text">
                ...
                and conditions by which you may access Akuda.io ("the Site") and app.Akuda.io ("the Interface"). Please do
            ...
            <div className="section">
              ...
              <p className="body-text">The Akuda.io site is for informational purposes only.</p>
              <p className="body-text">
                Akuda.io is not part of any transaction on the blockchain networks underlying the Akuda Protocol; we do not
                ...
                any crypto assets. You understand that when you interact with any Akuda Protocol smart contracts, you
                always retain control over your crypto assets. We do not have access to your private keys.
              </p>
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    1.1. As a condition to accessing or using the Site or Interface, you represent and warrant to Akuda.io
                    the following:
                  </p>
                  <ul className="list-style-none">
                    <li>
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        administrative authority having jurisdiction over Akuda.io or you as otherwise duly enacted,
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        ...
                        procedures or repairs that Akuda.io or any of its suppliers or contractors may undertake from time
                        to time; (c) causes beyond Akuda.io's control or that Akuda.io could not reasonably foresee; (d)
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        transaction with Akuda.io;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">1.2.5. Akuda.io does not act as a broker or advisor for you;</p>
                    </li>
                    <li>
                      <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                fees. Akuda.io does not receive fees for any blockchain transactions or using the Site or the Interface.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    4.1. Akuda.io own all rights, names, logos, and other marks used on the Site and the Interface,
                    including, without limitation, any copyrights in and to any content, code, data, or other materials
                    that you may access or use on or through the Site or the Interface; however, the code for the Akuda
                    Protocol and the Interface (app.Akuda.io) deployed on IPFS is open-sourced. Except as expressly set
                ...
                <li>
                  <p className="body-text">
                    4.2. Akuda.io may use and share your comments, bug reports, ideas, or other feedback that you may
                    provide, including suggestions about how we might improve. You agree that Akuda.io is free to use or
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    5.1. Akuda.io reserve the right, at our sole discretion, from time to time and with or without prior
                    ...
                    own its code. Akuda.io will not be liable for any losses suffered by you resulting from any
                ...
                <li>
                  <p className="body-text">
                    5.2. Akuda.io may revise these Terms from time to time. We will notify you by updating the date at the
                    top of the Terms and maintaining a current version. The most current version of the Terms will
                    always be at https://Akuda.io/#/terms-and-conditions. All modifications will be effective when they
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    ...
                    others, entails a risk that by accessing transactions, you are assuming. Akuda.io does not own or
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        6.1.1. That Akuda.io is not responsible for the operation of the open-source software and networks
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        blockchain-based network. Neither Akuda.io nor any other person or entity will be able to retrieve
                ...
                <li>
                  <p className="body-text">
                    6.2. Akuda.io is not responsible for the content of any third party, including, but not limited to,
                    information, materials, products, or services that Akuda.io does not own or control. In addition,
                    third parties may offer promotions related to your access and use of the Interface. Akuda.io does not
                    ...
                    You expressly relieve Akuda.io of all liability arising from using such resources or participating in
                    such promotions.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p className="body-text">
                    6.6. You hereby assume and agree that Akuda.io will have no responsibility or liability for the risks
                    in Section 9. You hereby irrevocably waive, release and discharge all claims, whether known or
                    unknown to you, against Akuda.io, its affiliates, and their respective shareholders, members,
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        right of publicity, privacy, or any other proprietary right of Akuda.io;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        7.1.6. Harass, abuse, or harm another person or entity, including Akuda.io's collaborator and
                        service providers;
                      </p>
                    </li>
                    <li>
            ...
            <div className="section">
              ...
              <p className="body-text">
                Akuda.io is an informational site for the Akuda Protocol. Akuda.io does not operate an exchange platform or
              ...
              <p className="body-text">
                You understand that Akuda.io is not registered or licensed by any regulatory agency or authority. No such
                agency or authority has reviewed or approved the use of the Site or the Interface.
              </p>
              <p className="body-text">
                You agree that the Site and the Interface are provided on an "AS IS" and "AS AVAILABLE" basis. Akuda.io
            ...
            <div className="section">
              ...
              <p className="body-text">
                In no event shall Akuda.io, its affiliates, its suppliers and contractors, and its affiliates', suppliers'
                ...
                or the Interface, or other item provided by or on behalf of Akuda.io, whether under contract, tort
                ...
                or any limited remedy hereunder nor is Akuda.io in any way responsible for the execution or settlement of
                transactions between users of the Interface.
              </p>
              <p className="body-text">
                In no event shall Akuda.io's aggregate liability arising out of or in connection with the Site or
            ...
            <div className="section">
              ...
              <p className="body-text">
                You will defend, indemnify, and hold harmless Akuda.io, its affiliates, members, member, managers,
            ...
            <div className="section">
              ...
              <p className="body-text">
                Akuda.io will use its best efforts to resolve potential disputes through informal, good faith
                negotiations. If a potential dispute arises, you must contact us by sending a written notice of your
                claim ("Notice") to Akuda.io on any of our official channels. The notice must (a) describe the nature and
                basis of the claim and (b) set forth the specific relief sought. Our notice to you will be similar in
                form to that described above. If you and Akuda.io cannot reach an agreement to resolve the claim within
                sixty (60) days of your email, then you and Akuda.io agree to resolve the potential dispute according to
              ...
              <p className="body-text">
                ...
                year after such claim arose; otherwise, the claim is permanently barred, which means that you and Akuda.io
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    13.1. Any right or remedy of Akuda.io set forth in these Terms is in addition to, and not in lieu of,
                    any other right or remedy whether described in these Terms, under Applicable Law, at law, or in
                    equity. The failure or delay of Akuda.io in exercising any right, power, or privilege under these
                ...
                <li>
                  <p className="body-text">
                    13.4. Akuda.io will have no responsibility or liability for any failure or delay in performance of the
                ...
                <li>
                  <p className="body-text">
                    13.6. These Terms contain the entire agreement between you and Akuda.io and supersede all prior and
            ...
            <div className="section">
              ...
              <p className="body-text">
                If you have any questions about these Terms, the Site, or the Interface, please get in touch with Akuda.io
