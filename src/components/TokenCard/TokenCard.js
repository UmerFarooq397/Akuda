    ...
    <div className="Home-token-card-options">
      <div className="Home-token-card-option">
        <div className="Home-token-card-option-icon">
          <img src={gmxIcon} width="40" alt="GMX Icons" /> Akudo
        </div>
        <div className="Home-token-card-option-info">
          <div className="Home-token-card-option-title">
            <Trans>Akuda is the utility and governance token. Accrues 30% of the platform's generated fees.</Trans>
          </div>
      ...
      <div className="Home-token-card-option">
        ...
        <div className="Home-token-card-option-info">
          <div className="Home-token-card-option-title">
            <Trans>
              GLP is the liquidity provider token for Akuda V1 markets. Accrues 70% of the V1 markets generated fees.
            </Trans>
          </div>
          <div className="Home-token-card-option-apr">
      ...
      <div className="Home-token-card-option">
        ...
        <div className="Home-token-card-option-info">
          <div className="Home-token-card-option-title">
            <Trans>
              GM is the liquidity provider token for Akuda V2 markets. Accrues 63% of the V2 markets generated fees.
            </Trans>
          </div>
